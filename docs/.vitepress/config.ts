...
const koSidebar = [
    ...
    items: [
      { text: '시나리오 카탈로그', link: '/ko/02-scenarios/' },
      {
        ...
        items: [
          ...
          { text: 'S3. 연구용 데이터셋 생성 및 제공', link: '/ko/02-scenarios/s3-research-dataset-generation' },
        ],
      },
      {
        text: '운영 시나리오',
  ...
  },
  {
    text: '위협 모델링',
    items: [
      { text: '위협 모델링 개요', link: '/ko/05-threat-modeling/' },
      ...
      { text: '신뢰 경계', link: '/ko/05-threat-modeling/04-trust-boundaries' },
      {
        ...
        items: [
          ...
          { text: 'T-04 데이터 전달 경로 및 객체 경로 오남용', link: '/ko/05-threat-modeling/05-threat-scenarios/t-004-data-delivery-and-object-path-abuse' },
  ...
  },
  {
    ...
    items: [
      { text: '개요', link: '/ko/06-runbook/' },
      {
        ...
        collapsed: false,
        items: [
          { text: '운영 상태 모델', link: '/ko/06-runbook/01-tenant-lifecycle#state-transition-rules' },
          ...
          { text: '중지 절차', link: '/ko/06-runbook/01-tenant-lifecycle#tenant-suspension' },
        ],
      },
      {
        text: '자격증명 및 키 관리',
        collapsed: false,
        items: [
          { text: '관리 원칙', link: '/ko/06-runbook/02-credentials-and-key-management#shared-principles' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: '초기 대응 원칙', link: '/ko/06-runbook/03-incident-response#initial-response-rules' },
          { text: '기록 확보 및 보존', link: '/ko/06-runbook/03-incident-response#evidence-preservation-checklist' },
          { text: '복구 선언 기준', link: '/ko/06-runbook/03-incident-response#recovery-declaration-baseline' },
