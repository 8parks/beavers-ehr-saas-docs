...
- 문서화 자료
  ...
  - `docs/ko/05-threat-modeling/04-trust-boundaries.md`
  - `docs/ko/05-threat-modeling/05-threat-scenarios/t-001-cross-tenant-access.md`
  - `docs/ko/05-threat-modeling/05-threat-scenarios/t-009-break-glass-misuse.md`
  - `docs/ko/05-threat-modeling/06-mitigations.md`
